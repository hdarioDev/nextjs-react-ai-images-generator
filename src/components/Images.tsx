...
// import { ImageType, useImages } from "@/app/context";
...
function Images() {
  ...
  return (
    <div>
      ...
      <div className="grid m-2 gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 px-0 md:px-10">
